...
/**
 * Get the RSVP schedule for the match day: always 6am CT - 10pm CT on that date.
 */
...
/**
 * Check if RSVP should be open: current time is within 6am–10pm CT on match day.
 * Manual open/close times are no longer used; schedule is always 6am–10pm CT on match day.
 */
